function [Xphi] = PSD_data_noplot(XXnew,delphi,Energy,E1,E2,demodindex)
%This function is part of the ME(XAS)-PSD Analysis Toolbox (LCT, Ghent University)
%v 1.0.1 - 13 December 2022
%Valentijn De Coster
%
%[Xphi] = PSD_data_noplot(XXnew,delphi,Energy,E1,E2,demodindex)
%The same function as “PSD”, i.e. does PSD of pre-averaged data and plots results, 
%BUT DOES NOT plot results, BUT DOES give the demodulated data as output “Xphi”, where each row represents 
...
%
%NOTE1: Though no plots are made, Energy, E1 and E2 have to be provided.
%NOTE2: Does not require custom codes to run.
