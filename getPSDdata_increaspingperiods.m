function [Xphidata] = getPSDdata_increaspingperiods(Xreprod,periods,delphi,Energy,E1,E2,demodindex)
%This function is part of the ME(XAS)-PSD Analysis Toolbox (LCT, Ghent University)
%v 1.0.1 - 13 December 2022
%Valentijn De Coster
%
%[Xphidata] = getPSDdata_increaspingperiods(Xreprod,periods,delphi,Energy,E1,E2,demodindex)
%
%This function generates phase-resolved data AND plots the data. 
...
%to "Xreprod". "E1" and "E2", ‘old’ energy ranges for plots, have to be provided.
%
...
for i=1:periods 
    ...
    Xphi{i}=PSD_data(Xiperiodsavg,delphi,Energy,E1,E2,demodindex);
